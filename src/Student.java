...
public class Student extends Person {
    ...
    public static class Builder {
        ...
        public Builder withAcademicDepartment(String academicDepartment) {
            newStudent.academicDepartment = academicDepartment;
            return this;
        }

        public Builder withAcademicGroup(String academicGroup) {
            newStudent.academicGroup = academicGroup;
            return this;
        }
        ...
        public Builder withSpecialtyCode(String specialtyCode) {
            newStudent.specialtyCode = specialtyCode;
            return this;
        }

        public Builder withFieldOfKnowledge(String fieldOfKnowledge) {
           newStudent.fieldOfKnowledge = fieldOfKnowledge;
           return this;
        }

        public Builder withFieldOfKnowledgeCode(String fieldOfKnowledgeCode) {
            newStudent.fieldOfKnowledgeCode = fieldOfKnowledgeCode;
            return this;
        }

        public Builder withStudentTicketNumber(String studentTicketNumber) {
            newStudent.studentTicketNumber = studentTicketNumber;
            return this;
        }

        public Builder withAdmissionDate(LocalDate admissionDate) {
            newStudent.admissionDate = admissionDate;
            return this;
        }

        public Builder withStudyPeriod(int studyPeriod) {
            newStudent.studyPeriod = studyPeriod;
            return this;
        }

        public Builder withTotalNumberOfDisciplines(int totalNumberOfDisciplines) {
            newStudent.totalNumberOfDisciplines = totalNumberOfDisciplines;
            return this;
        }

        public Builder withAverageMark(double averageMark) {
            newStudent.averageMark = averageMark;
            return this;
        }

        public Builder withNumberOfAcademicDebts(int numberOfAcademicDebts) {
            newStudent.numberOfAcademicDebts = numberOfAcademicDebts;
            return this;
        }

        public Builder withNumberOfScientificPublications(int numberOfScientificPublications) {
            newStudent.numberOfScientificPublications = numberOfScientificPublications;
            return this;
        }

        public Builder withEducationalLevel(String educationalLevel) {
            newStudent.educationalLevel = educationalLevel;
            return this;
        }

        public Builder withFormOfEducation(String formOfEducation) {
            newStudent.formOfEducation = formOfEducation;
            return this;
        }

        public Builder withScholarshipAmount(int scholarshipAmount) {
            newStudent.scholarshipAmount = scholarshipAmount;
            return this;
        }
        ...
        public Builder withIsStudentOfMilitaryDepartment(boolean isStudentOfMilitaryDepartment) {
            newStudent.isStudentOfMilitaryDepartment = isStudentOfMilitaryDepartment;
            return this;
        }
